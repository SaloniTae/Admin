...
async def do_approve_flow_immediate(client, message, slot_id, data):
    ...
    Immediately approve a successful payment:
      ...
      • Increment that credential’s usage counter (synchronously)
    """
    ...
    # If REF-ID or FTRIAL-ID prefix, place under that namespace; else directly under /transactions
    if txn_id.startswith("REF-"):
    ...
    # ── 9) Increment this credential’s usage counter (synchronous, as before) ─
