...
# ── 3) Wait for loader animation to complete ──────────────
    await loader_task  # let the animation finish

    # ── 3a) Now delete that loader message ───────────────────
    try:
    ...
    # ── 4) Send the actual QR photo + buttons ────────────────
    ...
    logger.info(f"[PhonePe] QR sent to user, order_id={order_id}")
